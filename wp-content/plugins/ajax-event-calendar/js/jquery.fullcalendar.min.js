        ...
        function e(i) {
            ...
            for (P = 0; P < E; P++) {
                ...
                if (!n.allDay && B.isStart) {
                    ...
                    k += "<span class='fc-event-time'>" + Qa(T(n.start, n.end, fa("timeFormat"))) + " - " + Qa(T(n.end, n.end, fa("timeFormat"))) + "</span>";
                } else if (n.allDay) {
                    k += " class='" + W.join(" ") + "' style='height:"+(jQuery('.fc-mon').children().height()-jQuery('.fc-mon').find('.fc-day-number').height())+"px;position:absolute;z-index:8;left:" + r + "px;" + M + "'><div class='fc-event-inner fc-event-skin'" + (M ? " style='" + M + "'" : "") + ">";

                    k += "<span class='fc-event-time allDay' ></span>";
                };
