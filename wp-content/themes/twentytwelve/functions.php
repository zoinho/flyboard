...
function myplugin_add_meta_box() {
	...
	foreach ( $screens as $screen ) {
		...
		add_meta_box(
			'myplugin_sectionid',
			__( 'Subtitle (shows in the header of the program name)', 'myplugin_textdomain' ),
...
function myplugin_meta_box_callback( $post ) {
	 ...
	 */
	$value = get_post_meta( $post->ID, 'program_subtitle', true );

	echo '<label for="myplugin_new_field">';
	_e( 'Enter your subtitle', 'myplugin_textdomain' );
	echo '</label> ';
...
function myplugin_save_meta_box_data( $post_id ) {
	...
	update_post_meta( $post_id, 'program_subtitle', $my_data );
}
...
function new_excerpt_more( $more ) {
	return ' <a class="read-more" href="'. get_permalink( get_the_ID() ) . '">' . __('Czytaj więcej', 'cfkrakow') . '</a>';
}
