...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
				...
				<a href="http://cfkrakow.com"><h1 class="logo"><span class="red">CF</span> Kraków</h1></a>
				<h2 class="sub-logo">CENTRUM FITNESS</h2>
				<h2 class="sub-logo">PIERWSZE TAKIE MIEJSCE W KRAKOWIE</h2>
				<h2 class="sub-logo">ul. Ludowa 6</h2>
